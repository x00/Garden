...
$Configuration['Garden']['Registration']['InviteExpiration']    = 'FALSE'; // '-1 week'; // The time before now that an invitation expires. ie. If an invitation was sent within the last week, it is still valid. This value will be plugged directly into strtotime()
